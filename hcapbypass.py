...
def N_Data(req) -> str:
        try:
            """
            cette partie prend la valeur req dans getsiteconfig et la convertit en notre hach, nous en avons besoin pour la dernière étape.
            (merci à h0nde pour cette fonction d'ailleurs)
            """
